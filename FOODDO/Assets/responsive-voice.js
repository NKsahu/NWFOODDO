...
if (typeof responsiveVoice != 'undefined') {
    ...
    var ResponsiveVoice = function () {
        ...
        var voicecollection = [
            ...
            { name: 'Hindi Female', lang: 'hi', fallbackvoice: true },
        ...
        self.speak = function (text, voicename, parameters) {
            ...
            for (var i = 0; i < multipartText.length; i++) {
                ...
                if (!fallbackMode) {
                    //Use SpeechSynthesis
                    console.log("profile.systemvoice.lang" + profile.systemvoice.lang);
                    //Create msg object
                    ...
                    msg.rate = profile.collectionvoice.rate || profile.systemvoice.rate || 0.1; // 0.1 to 10
                    msg.pitch = profile.collectionvoice.pitch || profile.systemvoice.pitch || 2; //0 to 2*/
        ...
        self.setDefaultVoice = function (voicename) {
            ...
            console.log("Language detect:"+self.default_vr);
           // self.default_vr = "Hindi Female";
